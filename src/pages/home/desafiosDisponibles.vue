    ...
    <section class="pl-5 pt-5">
        <div class="row mx-0 a-center">
            <p class="col-8 font-bold-italic f-28">
                CREA TU DESAFIO Y PREPÁRATE PARA LA COMPETENCIA
            </p>
            <div class="col-auto mr-2 px-0">
                <div class="btn-general px-3 f-300" @click="irCrearDesafio">
                    CREAR DESAFIO
                </div>
            </div>
        </div>
        <template v-if="!noInformacion">
            <div v-for="(des, d) in disponibles" :key="d" class="row mx-0 mb-4">
                ...
                <div v-for="(reto, p) in des.retos" :key="p" class="col-12 px-0 mb-4">
                    <div class="row mx-0">
                                ...
                                <div class="col px-0">
                                    ...
                                    <div class="d-middle mt-2">
                                        <div class="col-auto px-0 cr-pointer" @click="irVerTribu(reto.created_by)">
                                            ...
                                            <p class="f-14 text-center">{{ reto.retador }}</p>
                                        </div>
                                        ...
                                        <div class="col-auto px-0 cr-pointer" @click="irVerTribu(reto.id_user_2)">
                                            ...
                                            <p class="f-14 text-center">{{ reto.oponente1 }}</p>
                                        </div>
                                        <template v-if="reto.cantidad > 2">
                                            ...
                                            <div class="col-auto px-0 cr-pointer" @click="irVerTribu(reto.id_user_3)">
                                                ...
                                                <p class="f-14 text-center">{{ reto.oponente2 }}</p>
                                            </div>
                                            <template v-if="reto.cantidad > 3">
                                                ...
                                                <div class="col-auto px-0 cr-pointer" @click="irVerTribu(reto.id_user_4)">
                                                    ...
                                                    <p class="f-14 text-center">{{ reto.oponente3 }}</p>
                                                </div>
                                            </template>
                                        </template>
                                    </div>
                                </div>
                                <div class="col-auto text-general px-0">
                                    ...
                                    <div class="row mx-0 justify-content-end">
                                        <div class="btn-general font-medium-italic px-3" style="width:159px;" @click="irVerDesafio(reto.id)">
                                            Ver Desafio
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- <div class="row mx-0">
                            <div class="col-auto text-general ml-auto">
                                dwada
                            </div>
                        </div> -->
        ...
        <modal-pedir-password ref="modalpedirpassword" titulo="CREAR DESAFIO" texto="Ingresa tu contraseña de líder para crear un desafio" @data="irValidar" />
    </section>
</template>
...
export default {
    ...
    created() {
        this.getDesafiosDisponibles();
    },

    methods: {
        async getDesafiosDisponibles() {
            try {
                let params =  {
                    estado: 1
                }
                const {data} = await Desafio.getDesafiosDisponibles(params)
                this.disponibles = data.retos;
        ...
        irValidar(usuario) {
            if (usuario.tipo === 1) {
                this.irCrearDesafio();
                this.$router.push({name: 'crear-desafio', params:{id:usuario.id}});
            } else {
